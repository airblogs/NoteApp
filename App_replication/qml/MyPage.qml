...
Page {
  ...
  Item{
      ...
      AppListView {
          ...
          model:ListModel {
              id:lm
               ListElement { name: "修改用户资料" ;images:"../../App_replication/mypage2.png"}
               ListElement { name: "修改文件资料" ;images:"../../App_replication/mypage1.png"}
               ListElement { name: "帮助" ;images:"../../App_replication/mypage3.png"}
             }
          delegate: SimpleRow {
              height: 200
              Item {
